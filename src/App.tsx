...
import { processBackgroundRemoval, warmupAIModel } from './utils/imageProcessing';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Warm up AI model in background to eliminate cold-start download wait (2-3s Turbo)
