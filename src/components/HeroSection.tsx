...
import { validateImageFile, warmupAIModel } from '../utils/imageProcessing';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full my-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            {/* Top Pill Badge */}
            <div
              className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-cyan-950/40 border border-cyan-400/30 text-cyan-300 text-[10px] sm:text-xs font-bold tracking-wide uppercase shadow-lg shadow-cyan-950/40 backdrop-blur-md"
            >
              <Zap className="w-3 sm:w-3.5 h-3 sm:h-3.5 text-cyan-400 animate-pulse" />
              ⚡ 2-3s Turbo AI Cutout · WebGPU Accelerated
            </div>
                ...
                <div className="space-y-3.5 sm:space-y-5">
                  ...
                  <div className="text-center space-y-2 sm:space-y-3">
                    ...
                    <button
                      ...
                      onMouseEnter={() => void warmupAIModel()}
                      onTouchStart={() => void warmupAIModel()}
